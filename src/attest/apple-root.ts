// The pinned Apple App Attestation Root CA. Every App Attest certificate chain must end
// at this root; there is no other trust source for attestations.
//
// Downloaded from https://www.apple.com/certificateauthority/Apple_App_Attestation_Root_CA.pem
// SHA-256 fingerprint (verify after any update, it should never change before 2045):
